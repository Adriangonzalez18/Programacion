...
public class ProgramaAgenda {
	...
	public static void main(String[] args) {
		...
		String [] opciones = {"1) Añadir Contacto", "2) Eliminar Contacto", "3) Existe Contacto","4) Mostrar toda la agenda"
				,"5) Buscar Contacto","6) Salir"};
			...
			if(op.equals("1")){
				...
				if( agenda.numeroactualagenda > 0)
				{
					...
					if(nombre != null)
					{
						...
						{
							if(agenda.agendas[i].getNombre().equalsIgnoreCase(nombre)) {
